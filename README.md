...
- [add husky and lint-staged pre-commit checks](https://github.com/run-llama/liteparse/pull/161) on [run-llama/liteparse](https://github.com/run-llama/liteparse) (4 months ago)
